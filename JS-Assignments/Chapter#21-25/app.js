...
let password = prompt("Please enter a password to store but make sure: \n 1. It consists of numbers and alphabets both \n 2. No other sign 3. Should be atleast 6 characters long \n 4. Must not start with a Number")

let numberValid = false;
let letterValid = false;
let firstLetterValid = false;
...
if(numberValid && letterValid && firstLetterValid && passwordLength){
    document.writeln(password);
}else{
    document.writeln("Please Fulfill The Requirements");
}
